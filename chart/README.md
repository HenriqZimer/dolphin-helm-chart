...
[![Version: 1.1.0](https://img.shields.io/badge/Version-1.1.0-informational?style=flat-square)](https://github.com/HenriqZimer/dolphin-helm-chart)
...
helm package chart/
helm install dolphin ./dolphin-1.1.0.tgz
```
...
broker port (e.g. `http://dolphin.<namespace>.svc.cluster.local:8000`) and
