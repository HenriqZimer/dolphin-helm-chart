...
[![Version: 1.0.0](https://img.shields.io/badge/Version-1.0.0-informational?style=flat-square)](https://github.com/HenriqZimer/dolphin-helm-chart)
...
helm package chart/
helm install dolphin ./dolphin-1.0.0.tgz
```
