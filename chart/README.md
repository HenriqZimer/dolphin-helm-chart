...
[![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square)](https://github.com/HenriqZimer/dolphin-helm-chart)
...
helm package chart/
helm install dolphin ./dolphin-0.1.0.tgz
```
