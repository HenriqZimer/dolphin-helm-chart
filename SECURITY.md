...
When deploying Dolphin using this Helm chart:
...
4. **Updates**
   ...
   - Monitor security advisories for the upstream [linuxserver/docker-dolphin](https://github.com/linuxserver/docker-dolphin) image.
