# Contributing to Dolphin Helm Chart
...
helm template dolphin chart/

# Install in a test cluster
helm install dolphin-test chart/ --dry-run --debug
```
...
- Update `appVersion` in `Chart.yaml` in your PR when pinning the chart to a specific Dolphin image
